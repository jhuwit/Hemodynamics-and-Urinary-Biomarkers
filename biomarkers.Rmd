...
```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predmort, data = biowide, family = "binomial"))
# tidy(glm(AKI_48 ~ red5mins + white5mins + blue5mins + predmort, data = biowide, family = "binomial"), exponentiate = TRUE, conf.int = TRUE)
```
```{r}
 tidy(glm(AKI_48 ~ red5mins + white5mins + blue5mins + predmort, data = biowide, family = "binomial"), exponentiate = TRUE, conf.int = TRUE)
```
...
```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
...
```{r}
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"),exponentiate = TRUE, conf.int = TRUE)
```
...
```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predmort+cpbtime, data = biowide, family = "binomial"))
...
```{r}
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predmort+cpbtime, data = biowide, family = "binomial"),exponentiate = TRUE, conf.int = TRUE)
```


```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predrenf, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ red5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ white5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ blue5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ red5mins+white5mins+blue5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
```
...
m1 <- lme(ngal_diff ~ whitezone5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predmort +cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ redzone5mins+predrenf +cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ whitezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ bluezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
m1 <- lme(nephro_diff ~ whitezone5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predmort +cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ redzone5mins+predrenf +cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ whitezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ bluezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(nephro_diff ~ redzone5mins +whitezone5mins+bluezone5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
# Create phys zones and combine minutes in physzones to biowide
hemodynamics = hemodynamics %>%
  mutate(phys_zones = case_when(
           CVP>10 & MAP<=65 ~ "Zone 4", 
         CVP>10 & MAP>65 ~ "Zone 3", 
         CVP<=10 & MAP<=65 ~ "Zone 2", 
         CVP<=10 & MAP>65 ~ "Zone 1"
           )) %>%
  mutate(phys_zones = factor(phys_zones, 
                          levels = c("Zone 1", "Zone 2", "Zone 3", "Zone 4")))

zone_summary <- hemodynamics %>%
  group_by(harbor_id, phys_zones) %>%
  summarise(
    total_minutes = n() / 60, 
    .groups = "drop"
  )

zone_wide <- zone_summary %>%
  pivot_wider(
    names_from = phys_zones, 
    values_from = total_minutes,
    values_fill = 0  
  )%>%
  select(-any_of("NA")) %>%
  rename(
    physzone4_5mins  = `Zone 4`,
    physzone3_5mins = `Zone 3`,
    physzone2_5mins   = `Zone 2`,
    physzone1_5mins  = `Zone 1`
  )

biowide = biowide %>% left_join(zone_wide, by="harbor_id")
```
...
```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predmort, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+MAPless65_5mins, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predmort+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+cpbtime, data = biowide, family = "binomial"))
```



```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predrenf, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+MAPless65_5mins, data = biowide, family = "binomial"))
```

```{r,echo=FALSE}
tidy(glm(AKI_48 ~ physzone1_5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone2_5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone3_5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone4_5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
tidy(glm(AKI_48 ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+cpbtime, data = biowide, family = "binomial"))
```
...
offcpb_hemo = hemodynamics %>% group_by(harbor_id) %>% filter(wftime<=cpboff_last) %>% mutate(harbor_id=as.integer(harbor_id))%>% summarise(
  physzone1_5mins=sum(phys_zones=="Zone 1", na.rm = TRUE)  / 60,
  physzone2_5mins=sum(phys_zones=="Zone 2", na.rm = TRUE)  / 60,
  physzone3_5mins=sum(phys_zones=="Zone 3", na.rm = TRUE)  / 60,
  physzone4_5mins=sum(phys_zones=="Zone 4", na.rm = TRUE)  / 60,
  MAPless65_5mins= sum(MAP<65,na.rm=TRUE)/60)%>% mutate(timepoint=rep("OffCPB",n()))

icu_hemo =  hemodynamics %>% group_by(harbor_id) %>% mutate(harbor_id=as.integer(harbor_id)) %>% summarise(
  physzone1_5mins=sum(phys_zones=="Zone 1", na.rm = TRUE)  / 60,
  physzone2_5mins=sum(phys_zones=="Zone 2", na.rm = TRUE)  / 60,
  physzone3_5mins=sum(phys_zones=="Zone 3", na.rm = TRUE)  / 60,
  physzone4_5mins=sum(phys_zones=="Zone 4", na.rm = TRUE)  / 60,
  MAPless65_5mins= sum(MAP<65,na.rm=TRUE)/60)%>% mutate(timepoint=rep("ICU",n()))
...
m1 <- lme(ngal_diff ~ physzone1_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ physzone1_5mins +predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone2_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone3_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone4_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(ngal_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predmort+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+MAPless65_5mins, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
```{r,echo=FALSE}
m1 <- lme(nephro_diff ~ physzone1_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone2_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone3_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone4_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
m1 <- lme(nephro_diff ~ physzone1_5mins+physzone2_5mins+physzone3_5mins+physzone4_5mins+predrenf+cpbtime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))%>%
  gt() %>% cols_width(
    term ~ px(250),                    
...
### Linear Regression nephrocheck 24hICU- Baseline

```{r,echo=FALSE}
tidy(lm(akiscore_3_0~physzone1_5mins, data=biowide))
tidy(lm(akiscore_3_0~physzone2_5mins, data=biowide))
tidy(lm(akiscore_3_0~physzone3_5mins, data=biowide))
tidy(lm(akiscore_3_0~physzone4_5mins, data=biowide))
```



```{r,echo=FALSE}
biowide %>% ggplot(aes(x=physzone1_5mins, y= akiscore_3_0))+geom_point()
biowide %>% ggplot(aes(x=physzone2_5mins, y= akiscore_3_0))+geom_point()
biowide %>% ggplot(aes(x=physzone3_5mins, y= akiscore_3_0))+geom_point()
biowide %>% ggplot(aes(x=physzone4_5mins, y= akiscore_3_0))+geom_point()
```
...
```{r,echo=FALSE}
cor_matrix <- biowide %>%
  select(predmort, physzone1_5mins, physzone2_5mins, physzone3_5mins, physzone4_5mins, MAPless65_5mins, cpbtime) %>%
...
```{r,echo=FALSE}
covs=biowide %>% dplyr::select(patientage,gender,bmi,rfhypertension,rfdiabetes,priormi,hemodataef,rfpriorcva ,rfchroniclungdisease,medsbetablockerswithin24hours, rfhemoglobin,rflastcreatlevel,proctime,cpbtime,packed_rbc,predmort, predrenf, heartfailure, vasopressor, total_crystalloid)

covs %>% tbl_summary(statistic=all_continuous()~"{mean} ({sd})", missing_text = "Missing")



covs=biowide %>% dplyr::select(AKI_48,patientage,gender,bmi,rfhypertension,rfdiabetes,priormi,hemodataef,rfpriorcva ,rfchroniclungdisease,medsbetablockerswithin24hours, rfhemoglobin,rflastcreatlevel,proctime,cpbtime,packed_rbc, predmort, predrenf, heartfailure, vasopressor, total_crystalloid)

covs %>% tbl_summary(by=AKI_48,statistic=all_continuous()~"{mean} ({sd})", missing_text = "Missing")

covs %>% tbl_summary(by=AKI_48,statistic=all_continuous()~"{mean} ({sd})", missing_text = "Missing") %>% add_p() %>%
  as_tibble() %>%
  write.csv("aki_table.csv", row.names = FALSE)
...
- Mixed effects model with log2ngal_UCr offcpb/ICU minus baseline as outcome  
- Only use pre CPB measurements for OffCPB and pre/post measurements for ICU 
...
offcpb_hemo = hemodynamics %>% group_by(harbor_id) %>% filter(cat_cpb=="pre") %>% mutate(harbor_id=as.integer(harbor_id))%>% summarise(mapless65_ciless2=sum(MAP<65 & CI<2,na.rm=TRUE)/60, mapless65_cigrt2=sum(MAP<65 & CI>=2,na.rm=TRUE)/60, mapgrt65_ciless2=sum(MAP>=65 & CI<2,na.rm=TRUE)/60,mapgrt65_cigrt2=sum(MAP>=65 & CI>=2,na.rm=TRUE)/60)%>% mutate(timepoint=rep("OffCPB",n()))

icu_hemo =  hemodynamics %>% group_by(harbor_id) %>% filter(cat_cpb=="pre"| cat_cpb=="post") %>% mutate(harbor_id=as.integer(harbor_id))%>% summarise(mapless65_ciless2=sum(MAP<65 & CI<2,na.rm=TRUE)/60, mapless65_cigrt2=sum(MAP<65 & CI>=2,na.rm=TRUE)/60, mapgrt65_ciless2=sum(MAP>=65 & CI<2,na.rm=TRUE)/60,mapgrt65_cigrt2=sum(MAP>=65 & CI>=2,na.rm=TRUE)/60)%>% mutate(timepoint=rep("ICU",n()))
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ mapless65_ciless2 + predmort , random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapless65_cigrt2+ predmort , random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapgrt65_ciless2+ predmort , random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapgrt65_cigrt2+ predmort , random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```
...
```{r,echo=FALSE}
m1 <- lme(ngal_diff ~ mapless65_ciless2 + predmort +proctime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapless65_cigrt2+ predmort +proctime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapgrt65_ciless2+ predmort +proctime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))

m1 <- lme(ngal_diff ~ mapgrt65_cigrt2+ predmort +proctime, random=~1 | harbor_id, data = biomarkers2)
tidy(m1, effects = "fixed", conf.int = TRUE, conf.level = 0.95)%>%
  mutate(across(where(is.numeric), ~ round(.x, 4)))
```


CO/MAP zones 1, zone 2, zone 3, zone 4 = outcome only change in logNGAL_UCR

```{r,echo=FALSE}
biomarkers2 = biomarkers2 %>% filter(timepoint=="ICU") 

tidy(lm(ngal_diff~mapless65_ciless2, data=biomarkers2))

tidy(lm(ngal_diff~mapless65_cigrt2, data=biomarkers2))

tidy(lm(ngal_diff~mapgrt65_ciless2, data=biomarkers2))

tidy(lm(ngal_diff~mapgrt65_cigrt2, data=biomarkers2))


tidy(lm(ngal_diff~mapless65_ciless2+mapless65_cigrt2+mapgrt65_ciless2+mapgrt65_cigrt2, data=biomarkers2))
```
...
cols_to_use <- c("physzone1_5mins","physzone2_5mins","physzone3_5mins","physzone4_5mins")

# 2. Create the table
summary_table <- data.frame(
  mean = sapply(biowide[cols_to_use], mean, na.rm = TRUE),
  sd   = sapply(biowide[cols_to_use], sd, na.rm = TRUE)
)
